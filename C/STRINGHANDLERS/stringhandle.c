...
char * 
append_char_to_string(const char * string, const char char_to_append, 
...
void 
str_replacechar(char * string, const char char_to_subs,  
...
void 
print_str_to_ascii_code(char * string)
{
    do
    {   
        if(*(string) != '\0')
